...
export default function ProjectCard({ project, index }: { project: any, index: number }) {
    ...
    return (
        ...
        >
            ...
            <div className={`h-72 bg-gradient-to-br ${project.gradient} relative overflow-hidden`}>
                {project.image ? (<Image src={project?.image} alt={project.title} className="w-full h-full object-cover" width={500} height={700} />) : (
                   <>
