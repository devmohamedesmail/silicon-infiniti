...
export default function LanguageSwitcher() {
    ...
    return (
        <button
            ...
            className="fixed bottom-8 left-8 z-50 p-4 bg-primary text-primary-foreground rounded-full shadow-lg hover:glow-primary transition-all duration-300 hover:scale-110 group"
