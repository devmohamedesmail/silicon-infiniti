        ...
        <section id="projects" className="relative py-20 md:py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mt-16 fade-in" style={{ animationDelay: '0.8s' }}>
                    <button className="px-8 py-4 bg-primary text-primary-foreground rounded-lg font-semibold text-lg hover:glow-primary transition-all duration-300 hover:scale-105">
                        {t('projects.viewAll')}
                    </button>
                </div>
            </div>
